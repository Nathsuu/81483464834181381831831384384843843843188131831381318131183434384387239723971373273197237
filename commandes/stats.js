...
module.exports.run = async (client, message) => {
 ...
 const embed = new Discord.RichEmbed()
  ...
  .addBlankField() 
  .addField(":floppy_disk: Utilisateurs :", message.guild.memberCount, true)
  .addField(":floppy_disk: Channels :", message.guild.channels.size, true) 
  .addField(":floppy_disk: Roles :", message.guild.roles.size, true)
  .addBlankField() 
