...
module.exports.run = async (client, message) => {
 ...
 const embed = new Discord.RichEmbed()
  ...
  .addBlankField() 
  .addField(":floppy_disk: Utilisateurs sur le Discord :" + message.guild.members.filter(m => m.message.guild.memberCount).size, true)
  .addField(":floppy_disk: Channels sur le Discord :"+ message.guild.members.filter(m => m.message.guild.channels.size).size, true) 
