...
if (!amount) return message.reply(':x: Veuillez mentionner une limite de message comprise entre 3 et 100'); 
if (!amount && !user) 
return message.reply(':x: Veuillez mentionner une limite de message comprise entre 3 et 100');
if (!user){ 
if(isNaN(message.content.split(' ')[1]) || parseInt(message.content.split(' ')[1]) < 2 || parseInt(message.content.split(' ')[1]) > 100){
message.channel.send(':x: Veuillez mentionner une limite de message comprise entre 2 et 100')
}
}
