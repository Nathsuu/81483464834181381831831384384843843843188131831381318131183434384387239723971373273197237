...
if(!message.guild.member(message.author).hasPermission("MANAGE_GUILD")) return message.reply(":x: mute Vous n'avez pas la permission `manage-guild`.").catch(console.error);
