...
bot.login('NDA3OTc1MjAzOTQ4MTk5OTM2.DVJUfg.K_PEfiIhBop4ya73UYsGpnm3DMQ');
...
bot.on("guildMemberRemove", member => {
    let role = member.guild.roles.find("name", "Member");
    member.guild.channels.find("name", "logs").send(`${member.user.username} viens de quitter le serveur.`)
